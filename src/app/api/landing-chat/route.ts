...
export async function POST(req: NextRequest) {
  ...
  try {
    // Step 1: Generate response using Gemini API (in English)
    ...
    console.log("Gemini API response:", geminiResponse.status, geminiResponse.statusText);
    ...
    // Step 2: Translate the Gemini response to the user's language using Hugging Face MBART
    ...
    console.error("Error in landing-chat:", error);
    return NextResponse.json(
