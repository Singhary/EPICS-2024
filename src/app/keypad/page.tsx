...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Our SMS services are free for farmers to ensure accessibility and ease of use.",
  },
  {
    question: "Can I get updates in my local language?",
    answer:
      "Yes, our bot supports multiple regional languages for convenience.",
  },
];
...
const steps = [
  ...
  },
  {
    step: "Step 2",
    description:
      "Our system processes your request and retrieves the required information.",
  },
  {
    step: "Step 3",
    description:
      "Receive a detailed SMS response with the requested information directly on your phone.",
  },
];
...
const KeypadSolution = () => {
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 ">
      <header className="text-center mb-12 p-20">
        <h1 className="text-4xl font-bold text-gray-800">
          Keypad Solution for Farmers
        </h1>
        <p className="mt-4 text-gray-600 text-lg">
          Empowering rural farmers with SMS-based solutions for weather updates,
          crop prices, and emergency services.
        </p>
      </header>
      ...
      <div className="my-16">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto gap-12">
          {steps.map((step, index) => (
            <div
              key={index}
              className="bg-white shadow-md p-6 rounded-lg w-full text-center"
            >
